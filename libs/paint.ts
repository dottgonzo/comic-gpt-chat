...
export async function paint(panel: TPanel) {
  let prompt = `Draw a single panel of a comic. The background of the panel is ${panel.background}. In this single panel you have to represent the following dialogue only between these nearby actors using balloons:\n\n`;
